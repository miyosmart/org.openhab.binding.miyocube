 ...
 */
@NonNullByDefault
public class MiyoCubeHandler extends BaseThingHandler {

    private final Logger logger = LoggerFactory.getLogger(MiyoCubeHandler.class);

    private @Nullable MiyoCubeConfiguration config;

    public MiyoCubeHandler(Thing thing) {
        super(thing);
    }
    ...
    public void initialize() {
        config = getConfigAs(MiyoCubeConfiguration.class);
