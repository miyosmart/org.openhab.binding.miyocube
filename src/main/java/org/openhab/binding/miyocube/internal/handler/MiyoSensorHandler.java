...
/**
 * The {@link MiyoSensorHandler} is responsible for handling sensor things
 *
 * @author Fabian Obernberger - Initial contribution
 */
@NonNullByDefault
public class MiyoSensorHandler extends MiyoThingHandler {

    public MiyoSensorHandler(Thing thing) {
        super(thing);
    }
